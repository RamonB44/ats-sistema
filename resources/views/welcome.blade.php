                        ...
                        <div class="card-body">
                            ...
                            <div style="overflow:auto;margin-top:15px">
                                <div class="d-flex justify-content-around">
                                    <button type="button" class="btn btn-primary btn-lg " style="width: 33.333%"
                                        id="prevBtn" onclick="nextPrev(-1)">Anterior</button>
                                    <button type="button" class="btn btn-primary btn-lg " style="width: 33.333%"
                                        id="nextBtn" onclick="nextPrev(1)">Siguiente</button>
                                </div>
                            </div>
